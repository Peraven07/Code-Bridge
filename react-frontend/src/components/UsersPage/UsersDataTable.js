...
const UsersDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    const pTemplate2 = (rowData, { rowIndex }) => <p >{rowData.contactdetail}</p>
    const pTemplate3 = (rowData, { rowIndex }) => <p >{rowData.address}</p>
    const tickTemplate4 = (rowData, { rowIndex }) => <i className={`pi ${rowData.gender?"pi-check": "pi-times"}`}  ></i>
    ...
    return (
        <DataTable value={items} onRowClick={onRowClick} scrollable rowHover paginator rows={10}>
            ...
            <Column field="contactdetail" header="Contact Number" body={pTemplate2} style={{ minWidth: "8rem" }} />
            <Column field="address" header="Address" body={pTemplate3} style={{ minWidth: "8rem" }} />
            <Column field="gender" header="Gender" body={tickTemplate4} style={{ minWidth: "8rem" }} />
