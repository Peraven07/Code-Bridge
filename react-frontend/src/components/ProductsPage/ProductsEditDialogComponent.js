...
const ProductsCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        let _data = {
            ...
            productStock: _entity.productStock
    ...
    return (
        <Dialog header="Edit Info" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div role="products-edit-dialog-component">
                ...
                <div>
                    <p className="m-0" >Stock Availability:</p>
                    <Checkbox checked={_entity?.productStock} onChange={ (e) => setValByKey("productStock", e.checked)}  ></Checkbox>
                </div>
